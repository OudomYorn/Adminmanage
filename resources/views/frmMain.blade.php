...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="{{ asset('admin') }}/index2.html" class="logo"><b>Admin</b>LTE</a>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('student/form')}}"><i class="fa fa-circle-o"></i> Student</a></li>
                        <li><a href="{{url('subjects/form')}}"><i class="fa fa-circle-o"></i> Subject</a></li>
                        <li><a href="{{url('skill/form')}}"><i class="fa fa-circle-o"></i> Skill</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
